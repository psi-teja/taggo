...
const TriageHeader: React.FC<TriageHeaderProps> = ({
  ...
  return (
    <Header>
      ...
      <div className="flex items-center justify-between text-teal-900 w-[40vw] relative">
        {isEdit !== false && (
          <button
        ...
        <div className="flex flex-col mx-1 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <p className="text-gray-700 text-sm truncate max-w-[25rem]">
              {history ? `${history[history.length - 1]}` : ""}
            </p>
          </div>

          {showHistory && (
            <div className="absolute top-16 left-0 right-0 z-50 bg-white border border-gray-300 shadow-lg p-2 rounded-lg">
